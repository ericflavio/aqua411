...
import { listaFranquias } from '../../../services/franquiaService';
...
export default function ViewLojaVinculoFranquia() {
  ...
  const [listaFranquia, setListaFranquia] = useState(null)
  ...
  async function fetchDados() {
    try {
      carregaDadosObtidosNoLoading(await listaFranquias("s"));
