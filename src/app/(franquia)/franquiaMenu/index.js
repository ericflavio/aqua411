...
//Tela principal
export default function ViewFranquiaMenu() {
      ...
      <ScrollView style={[styleApp.containerScroll, { width: '100%' }]} contentContainerStyle={styleApp.containerScrollStyleContent} showsVerticalScrollIndicator={false}>
        <View style={{ justifyContent: 'center', alignItems: 'center' , backgroundColor:'white'}}>
          <Image
            ...
            source={{ uri: 'https://redeaquamagic.com.br/wp-content/uploads/2022/11/logolp2.webp' }}
          />
        </View>
          ...
          <>
            {parmLoja === null || statusList === null ?
              <View style={styles.containerDadosLoja}>
                <Text style={styleApp.textSubtitulo}>As informações da franquia eram esperadas e não foram recebidas.</Text>
              ...
              <>
                <View style={styles.containerDadosLoja}>
                  <Animatable.Text animation="slideInLeft" style={styleApp.textSubtitulo}>
                    {lojaDados.nome !== null && lojaDados.nome !== "" ? lojaDados.nome : "Aquamagic"}
                  </Animatable.Text>
                  <Text style={styleApp.textSmall}>Desde: <Text style={styles.textoStatus}>{lojaDados.status}</Text></Text>
                </View>
                ...
                <View style={styles.containerSection}>
                  <Text style={styleApp.textSmall}>Configuração da franquia</Text>
                ...
                <View style={styles.containerPrincipal}>
                  ...
                  <TouchableOpacity style={styleApp.buttonFlatHL_list} disabled={disabled} onPress={goToVinculoFranquia} >
                    <View style={{ flexDirection: "row", alignItems: "center" }}>
                      ...
                      <Text style={styleApp.textButtonFlat}>Lojas vinculadas</Text>
                    </View>
                    <MaterialIcons name="navigate-next" size={styleApp.size.iconSizeRegular} color={styleApp.color.cinzaMedio} />
                  </TouchableOpacity>
